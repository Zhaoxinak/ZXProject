...
- (void)setupViews {
    ...
    [UIView animateWithDuration:0.3 animations:^{
        ...
        _shareView.top = kScreen_Height - 250;
    }];
}
...
- (void)setupShareView {
    _shareView = [[UIView alloc] initWithFrame:CGRectMake(0, kScreen_Height, kScreen_Width, 250)];
    ...
    _collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 40, kScreen_Width, 200)
