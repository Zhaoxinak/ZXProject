...
- (TPKeyboardAvoidingScrollView *)pageScrollView
{
    if (_pageScrollView == nil) {
        _pageScrollView = [[TPKeyboardAvoidingScrollView alloc] init];
...
#pragma mark -设置tableView
- (TPKeyboardAvoidingTableView *)onetableView
{
    if (_onetableView == nil) {
        _onetableView = [[TPKeyboardAvoidingTableView alloc]init];
...
#pragma mark -设置tableView
- (TPKeyboardAvoidingTableView *)twoTableView
{
    if (_twoTableView == nil) {
        _twoTableView = [[TPKeyboardAvoidingTableView alloc]init];
...
#pragma mark -设置tableView
- (TPKeyboardAvoidingTableView *)threetableView
{
    if (_threetableView == nil) {
        _threetableView = [[TPKeyboardAvoidingTableView alloc]init];
...
#pragma mark -设置tableView
- (TPKeyboardAvoidingTableView *)fourTableView
{
    if (_fourTableView == nil) {
        _fourTableView = [[TPKeyboardAvoidingTableView alloc]init];
