...
- (TPKeyboardAvoidingScrollView *)pageScrollView
{
    if (_pageScrollView == nil) {
        _pageScrollView = [[TPKeyboardAvoidingScrollView alloc] initWithFrame:CGRectMake(0, 0, kScreen_Width, kScreen_Height-kScreen_NavHeight)];
...
#pragma mark -设置tableView
- (TPKeyboardAvoidingTableView *)lefttableView
{
    if (_lefttableView == nil) {
        _lefttableView = [[TPKeyboardAvoidingTableView alloc]initWithFrame:CGRectMake(0, 0, kScreen_Width, kScreen_Height-kScreen_NavHeight)];
...
#pragma mark -设置tableView
- (TPKeyboardAvoidingTableView *)rightTableView
{
    if (_rightTableView == nil) {
        _rightTableView = [[TPKeyboardAvoidingTableView alloc]initWithFrame:CGRectMake(0, 0, kScreen_Width, kScreen_Height-kScreen_NavHeight)];
